!function(t, e) {
    ...
    function r() {
        void 0 !== this._onBeforeStartCallback && this._onBeforeStartCallback.call(this), d.call(this);
    ...
    function n(t) {
        if (!t.hasAttribute("data-progressjs")) {
            ...
            document.querySelector(".progressjs-container").appendChild(r), o(t, 1), ++window._progressjsId
        }
    }
    function s(t) {
        for (var e = 0, r = this._targetElement.length; e < r; e++)
            o.call(this, this._targetElement[e], t)
    }
    function o(t, e) {
        var r = this;
        e >= 100 && (e = 100), t.hasAttribute("data-progressjs") && setTimeout(function() {
            void 0 !== r._onProgressCallback && r._onProgressCallback.call(r, t, e);
            var n = i(t);
            n.style.width = parseInt(e) + "%";
            var n = n.querySelector(".progressjs-percent"),
                s = parseInt(n.innerHTML.replace("%", ""));
            !function(t, e, r) {
                function n(t, e, r) {
                    var i = Math.abs(e - r);
                    i < 3 ? o = 30 : i < 20 ? o = 20 : intervanIn = 1, e - r != 0 && (t.innerHTML = (s ? ++e : --e) + "%", setTimeout(function() {
                        n(t, e, r)
                    }, o))
                }
                var s = !0;
    ...
    function l(t) {
        for (var e = 0, r = this._targetElement.length; e < r; e++) {
            ...
            if (n.hasAttribute("data-progressjs")) {
                var s = i(n),
                    a = parseInt(s.style.width.replace("%", ""));
                a && o.call(this, n, a + (t || 1))
            }
        }
    }
    function c() {
        void 0 !== this._onBeforeEndCallback && (!0 === this._options.considerTransition ? i(this._targetElement[0]).addEventListener(p(), this._onBeforeEndCallback, !1) : this._onBeforeEndCallback.call(this));
        for (var t = parseInt(this._targetElement[0].getAttribute("data-progressjs")), e = 0, r = this._targetElement.length; e < r; e++) {
            var n = this._targetElement[e],
                s = i(n);
            if (!s)
                return;
            var a = parseInt(s.style.width.replace("%", "")),
                l = 1;
            a < 100 && (o.call(this, n, 100), l = 500), function(t, e) {
                setTimeout(function() {
    ...
    function f(t) {
        ...
        for (var r = 0, n = 0; t && !isNaN(t.offsetLeft) && !isNaN(t.offsetTop);)
    ...
    return u.version = "0.1.0", u.fn = e.prototype = {
        clone: function() {
            return new e(this)
        },
